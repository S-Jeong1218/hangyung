...
<script type="text/javascript">
	$(document).ready(function(){
		...
		alert(email_info+","+emailid+","+emailurl);
		...
		<section>
			<form name="frm_mem" action="memberUpdatePlay.bizpoll" method="POST" id="frm_mem">
				...
				<div class="div_input" id="closet_name">
					<input type="text" placeholder="Name" class="input_join checkpw" id="inputname" name="inputname" value="${sessionScope.loginUser.name}">
				</div>
				
				<label for="inputphone" class="char_input">전화번호를 입력해주세요</label>
				<div class="div_input" id="closet_phone">
					<input type="text" placeholder="01012345678" class="input_join" id="inputphone" name="inputphone" value="${sessionScope.loginUser.phone}">
				</div>
				...
				<!-- </div> -->
				<input type="text" id="sample6_postcode" name="sample6_postcode" class="input_join inputaddr" placeholder="우편번호" readonly="readonly" value="${sessionScope.loginUser.zipcode}">
				<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" id="btn_addr"><br>
				<input type="text" id="sample6_address" name="sample6_address" class="input_join inputaddr" placeholder="주소" readonly="readonly" value="${sessionScope.loginUser.addr1}">
				<input type="text" id="sample6_address2" name="sample6_address2" class="input_join inputaddr" placeholder="상세주소" value="${sessionScope.loginUser.addr2}">
				...
				<div><a href="#" id="btn_join">회원 수정</a></div>
