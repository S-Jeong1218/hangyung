...
<div id="write_content_wrap">
	<h2>게시글 작성</h2>
	<form action="boardInsertPlay.bizpoll" id="frm_btn" name="frm_btn" method="post" enctype="multipart/form-data">
		...
		<span><input id="board_search_btn" type="submit" value="등록하기"></span>
	</form>
</div>
